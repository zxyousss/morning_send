...
for sender_info in sender_infos:
    ...
    data = {"user_name": {"value": sender_info["user_name"]},"other_name": {"value": sender_info["other_name"]}, "weather": {"value": wea}, "temperature": {"value": temperature}, "live_days": {"value": get_count(sender_info["start_date"])},"other_live_days": {"value": get_count(sender_info["other_start_date"])}, "birthday_left": {"value": get_birthday(sender_info["birthday"])}, "other_birthday_left": {"value": get_birthday(sender_info["other_birthday"])},"gk_left": {"value": get_birthday("06-06")},"words_chp": {"value": get_words(
